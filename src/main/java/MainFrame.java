...
public class MainFrame extends JFrame{
	...
	public void setServices(UIService ui, ImageDisplayService imageDisplayService) {
		...
		menuPanel.setServices(ui, imageDisplayService);
		computeTracksPanel1.setServices(ui, imageDisplayService);
		computeTracksPanel2.setServices(ui, imageDisplayService);
	}
